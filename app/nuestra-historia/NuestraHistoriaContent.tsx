...
const TIMELINE = [
  ...
  { year: "2002", yearKey: "2002", side: "right" as const, image: "/images/02.jpeg", imageAlt: "Carnes a las brasas en Lo de Jesús", showReservaButton: true },
                  ...
                  {item.side === "left" ? (
                    ...
                    <>
                      ...
                      <div className="flex flex-col gap-3 sm:gap-4 lg:pl-8 xl:pl-12">
                        {item.showReservaButton && (
                          <Link
                            href="/"
                            className="inline-flex min-h-[48px] items-center justify-center rounded bg-[#5C2D2B] px-12 py-3.5 text-center text-btn font-semibold uppercase tracking-[0.2em] text-white transition hover:bg-[#4a2523] focus-visible:ring-2 focus-visible:ring-[#5C2D2B] focus-visible:ring-offset-2 focus-visible:ring-offset-white lg:w-fit"
                          >
                            {t("historia.reserva")}
                          </Link>
                        )}
